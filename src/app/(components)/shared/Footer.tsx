...
export default function Footer() {
  return (
    <footer className="border-t border-gray-200 py-12 bg-white mt-16">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div>
            <h3 className="text-lg font-semibold text-gray-900 mb-3">PromptCrate</h3>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link href="/#mockup" className="text-gray-600 hover:text-purple-600 transition-colors">Product Demo</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link href="/contact" className="text-gray-600 hover:text-purple-600 transition-colors">Contact Us</Link></li>
              <li><Link href="/contact?subject=Enterprise%20Inquiry" className="text-gray-600 hover:text-purple-600 transition-colors">Enterprise Sales</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/terms" className="text-gray-600 hover:text-purple-600 transition-colors">Terms of Service</Link></li>
            </ul>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-gray-200 flex flex-col sm:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6 mt-4 sm:mt-0">
            ...
            <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-purple-600">
